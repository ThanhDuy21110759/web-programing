    ...
    <div class="bg-gray-100 h-screen justify-center">
        <center class="mt-24 m-auto">
            ...
            <div class=" tracking-widest mt-4">
                ...
                <span class="text-gray-500 text-xl">Internal Server Error</span><br>
                <span class="text-gray-500 text-xl">We are already working to solve the problem.</span>

            </div>
        </center>
        <center class="mt-6">
            <a href="${pageContext.request.contextPath}" class="text-gray-500 font-mono text-xl bg-gray-200 p-3 rounded-md hover:shadow-md">Go back </a>
        </center>
    </div>
</body>
</html>
